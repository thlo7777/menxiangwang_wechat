...
class WxPayDataBase
{
  ...
  protected $mch_key = null;
	...
	**/
	...
	{
		//签名步骤一：按字典序排序参数
    //watchdog('wxpayapi', 'url <pre>@data</pre>', array('@data' => print_r($this->values, TRUE)));
		ksort($this->values);
...
{	
	...
	* @return true 或 false
	**/
	public function IsMchKeySet()
	{
		return ($this->mch_key != null) ? true : false;
	}
